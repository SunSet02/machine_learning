...
![image-20230724105729681](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230724105729681.png)
...
![image-20230809162722475](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230809162722475.png)
...
![image-20230820163501985](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230820163501985.png)
...
![image-20230820165640612](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230820165640612.png)

### TensorFlow的auto diff

在TensorFlow中可以给出成本函数的计算公式后，根据一定的语法自动去运行梯度下降，避免手动的去计算导数（偏导数），示例如下

![image-20230820170721827](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230820170721827.png)

### 协同过滤算法在TensorFlow中的实现

![image-20230820171510748](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230820171510748.png)

### 寻找相关特征（寻找类似的电影、书籍）

​		如何实现寻找类似的电影、书籍，此时只需要计算另一些电影、书籍与当前的特征之间的距离，选择距离最小的就是类似的。

![image-20230820173345287](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230820173345287.png)
...
![image-20230820173910030](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230820173910030.png)
...
![image-20230822094419610](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822094419610.png)

#### 基于内容过滤算法的实现步骤：

1. 构建user feature和movie feature，两个向量的大小可以不一样

![image-20230822095607517](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822095607517.png)
...
![image-20230822100837402](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822100837402.png)

3. 计算v_u和v_m（使用神经网络模型）

![image-20230822101847931](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822101847931.png)

4. 成本函数

![image-20230822102433989](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822102433989.png)

基于内容的过滤算法如何找类似item？

和协同过滤算法寻找相关书籍（电影类似）只要计算v_m(k)和v_m(i)之间的距离，选择距离最小的几个即可。

![image-20230822102819189](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822102819189.png)

TensorFlow中的基于内容过滤算法实现：

![image-20230822165334128](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822165334128.png)
...
![image-20230822103814911](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822103814911.png)

2. ranking

![image-20230822104056005](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822104056005.png)
...
![image-20230822105619586](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822105619586.png)
...
![image-20230822205115113](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822205115113.png)

PCA技术将50多个特征压缩到2个

![image-20230822205513530](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822205513530.png)
...
![image-20230822211446386](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822211446386.png)

PCA不是linear regression，首先PCA是无监督学习的一种，线性回归模型是对y进行预测，而PCA是将多个特征进行压缩，在压缩的过程之中尽可能的保持方差

![image-20230822212211217](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822212211217.png)

#### PCA的重建

给定压缩后的距离可以近似的得到压缩前的数据位置，这个过程叫做PCA的重建，具体步骤如下，其中[0.71,0.71]是z方向上的单位向量，3.55是压缩后数据在z轴上的距离。

![image-20230822212816308](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822212816308.png)

#### PCA的代码实现

![image-20230822213531818](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822213531818.png)

![image-20230822214023426](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822214023426.png)



![image-20230822214300468](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230822214300468.png)
...
![image-20230826171055102](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230826171055102.png)

### 强化学习的回报

折扣因子：走n步折扣因子^n

![image-20230826171755946](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230826171755946.png)

eg:

![image-20230826172410502](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230826172410502.png)

### 强化学习算法如何选择动作

如何选择动作--->提出一个称为策略π的函数，告诉你在每个状态下采取什么样的行动以最大化回报。

![image-20230826173056622](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230826173056622.png)

![image-20230826172915973](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230826172915973.png)

![image-20230827101054562](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230827101054562.png)

马尔科夫决策过程：未来仅取决于当前状态，而不取决于在达到当前状态之前可能会发生的任何事情（未来仅取决于你现在的位置，而不取决于你是如何到达的）

![image-20230827101513172](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230827101513172.png)
...
![image-20230827102534420](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230827102534420.png)

![image-20230827103612530](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230827103612530.png)
...
![image-20230827105559297](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230827105559297.png)

eg:

![image-20230827110017104](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230827110017104.png)



**在强化学习中获得的回报有两部分：一部分是立即获得的奖励，另一部分是gamma从下一个状态获得的回报**

![image-20230827110704211](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230827110704211.png)
...
![image-20230827165050701](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230827165050701.png)



#### 贝尔曼方程

![image-20230827165241318](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230827165241318.png)
...
![image-20230828214514898](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230828214514898.png)



算法实现

![image-20230828111425608](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230828111425608.png)
...
![image-20230828214926815](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230828214926815.png)

##### epsilon-贪婪策略

在算法还在运行的时候，此时还不知道在状态s下的哪个action可以最大化Q（s，a）此时就可以采取epsilon-贪婪策略进行选取（大部分时间选取最大化的Q（s，a）少部分时间随机选取）spsilon的值可以随着训练时间的增加逐渐减小

![image-20230828220147864](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230828220147864.png)
...
![image-20230829095856338](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230829095856338.png)

![image-20230829100032461](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230829100032461.png)

mini-batch成本函数可能会出现一些偏差，但总体还是趋向于最小值：

![image-20230829100239787](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230829100239787.png)

###### 小批量在强化学习中的使用

![image-20230829100549882](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230829100549882.png)

##### soft update（op）

所谓soft update即为在强化学习中使用mini-batch后如果直接将Q = Qnew可能会因为一些不是很好的小组导致Qnew不如原来的Q，这样就可以采用soft update来对Q进行更新

![image-20230829102817602](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230829102817602.png)

![image-20230829104546864](C:\Users\Sunset\AppData\Roaming\Typora\typora-user-images\image-20230829104546864.png)
