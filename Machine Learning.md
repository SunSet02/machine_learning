...
![image-20230711174808155](E:\machine learning\img\image-20230711174808155.png)

定义成本函数：衡量一条线与训练数据的拟合程度（J（w,b））

![image-20230711221845687](E:\machine learning\img\image-20230711221845687.png)
...
![image-20230713170040513](E:\machine learning\img\image-20230713170040513.png)
$$
...
![image-20230713171756926](E:\machine learning\img\image-20230713171756926.png)



体验导数（偏导的作用）当只有一个变量w时：（不管初始w选取什么，让w每次的更新都朝着成本函数减少的方向更新）

![image-20230713173141068](E:\machine learning\img\image-20230713173141068.png)



学习率α的直观作用：

![image-20230713173913991](E:\machine learning\img\image-20230713173913991.png)
...
![image-20230713174544259](E:\machine learning\img\image-20230713174544259.png)
...
![image-20230713175419304](E:\machine learning\img\image-20230713175419304.png)
...
![image-20230717091641372](E:\machine learning\img\image-20230717091641372.png)
...
![image-20230717094603424](E:\machine learning\img\image-20230717094603424.png)

6. 预测

![image-20230717094728811](E:\machine learning\img\image-20230717094728811.png)
...
![image-20230717103306314](E:\machine learning\img\image-20230717103306314.png)
...
![image-20230717104313070](E:\machine learning\img\image-20230717104313070.png)
...
![image-20230717212111329](E:\machine learning\img\image-20230717212111329.png)

梯度下降：

![image-20230717212641546](E:\machine learning\img\image-20230717212641546.png)
...
![image-20230718104712875](E:\machine learning\img\image-20230718104712875.png)

特征缩放方法：

1. 除以最大值

![image-20230718105126822](E:\machine learning\img\image-20230718105126822.png)

2. 均值归一化（先计算特征的平均值，然后处理特征数据）

![image-20230718105648037](E:\machine learning\img\image-20230718105648037.png)

3. Z-score标准化（计算标准差西格玛和均值）

![image-20230718110238063](E:\machine learning\img\image-20230718110238063.png)

何时进行缩放：

![image-20230718110645963](E:\machine learning\img\image-20230718110645963.png)
...
![image-20230718162154499](E:\machine learning\img\image-20230718162154499.png)

2. 自动收敛测试（设置一个epsilon，当一次迭代过后成本函数的变化值小于epsilon时，此时可以认为梯度下降趋于收敛）

​		当然epsilon的取值并不好寻找，所以更趋向于使用学习曲线去判断梯度下降是否收敛

![image-20230718162419258](E:\machine learning\img\image-20230718162419258.png)
...
![image-20230718163339512](E:\machine learning\img\image-20230718163339512.png)
...
![image-20230718165814572](E:\machine learning\img\image-20230718165814572.png)
...
![image-20230719171519002](E:\machine learning\img\image-20230719171519002.png)

![image-20230719171754979](E:\machine learning\img\image-20230719171754979.png)

#### 决策边界（decision boundary）

决策边界是将逻辑回归模型中的预测值y（0-1范围）取一个边界值，当预测值>边界值时，可以认为分类结果为1（0），当预测值 < 边界值时，可以认为分类结果为 0（1）

![image-20230719175808552](E:\machine learning\img\image-20230719175808552.png)

逻辑转换：1-->2-->3-->4-->5(最后边界计算就到了回归模型里训练出来的w，b-->wx + b何时=0)

1. ![image-20230719175600273](E:\machine learning\img\image-20230719175600273.png)





2. ![image-20230719175634369](E:\machine learning\img\image-20230719175634369.png)





3. ![image-20230719175723037](E:\machine learning\img\image-20230719175723037.png)





4. ![image-20230719175740073](E:\machine learning\img\image-20230719175740073.png)





5. ![image-20230719175750565](E:\machine learning\img\image-20230719175750565.png)





eg:![image-20230719175934413](E:\machine learning\img\image-20230719175934413.png)

![image-20230719175947539](E:\machine learning\img\image-20230719175947539.png)

![image-20230719180000044](E:\machine learning\img\image-20230719180000044.png)

#### 成本函数：

1. 平方误差成本函数的不足：（成本变化随着w、b的变化不是一个凸函数，这样会使得梯度下降运行起来出现麻烦）

![image-20230720094353449](E:\machine learning\img\image-20230720094353449.png)
...
![image-20230720100814991](E:\machine learning\img\image-20230720100814991.png)

分析损失函数(L）：

1. 当y(i) = 1 时，即训练集里的真值为1时，损失函数选用上面的表达式形式，当预测结果![image-20230720101248545](E:\machine learning\img\image-20230720101248545.png)

的结果无限接近1时，此时损失函数无限接近于0，当预测结果![image-20230720101336372](E:\machine learning\img\image-20230720101336372.png)无限接近于0（即训练集训练出来的w，b对原样本进行预测分析时得到了相反的结果)，此时损失函数无限接近于无穷大。当预测结果![image-20230720101524983](E:\machine learning\img\image-20230720101524983.png)预测结果为0.1时，此时表明训练出来的结果有10%的概率认为其结果为1，此时损失函数较大。**x的预测值离y的真值越远，损失也就越大**图例如下：

![image-20230720101648880](E:\machine learning\img\image-20230720101648880.png)

2. 当y(i) = 0，即训练集里的真值为0时，损失函数选用下面的表达式形式，当预测结果![image-20230720101248545](E:\machine learning\img\image-20230720101248545.png)的结果无限接近于0（此时真值也为0)时，此时损失函数无限接近于0，当预测结果![image-20230720101248545](E:\machine learning\img\image-20230720101248545.png)无限接近于1（而真值为0)，此时损失函数无穷大，当预测结果![image-20230720101248545](E:\machine learning\img\image-20230720101248545.png)的预测值为0.7，此时即有70%的概率认为其预测结果为**1**，此时损失函数也较大。**x的预测值，离y的真值越远，损失也就越大**。图例如下:
...
![image-20230720104446968](E:\machine learning\img\image-20230720104446968.png)



损失函数的优化（将两个表达式合并成一个）

![image-20230720105259402](E:\machine learning\img\image-20230720105259402.png)
...
![image-20230720105531688](E:\machine learning\img\image-20230720105531688.png)
...
![image-20230720174131403](E:\machine learning\img\image-20230720174131403.png)

线性回归模型的梯度下降与二元分类的梯度下降公式的相同于不同之处：

![image-20230720174447442](E:\machine learning\img\image-20230720174447442.png)
...
![image-20230721103510572](E:\machine learning\img\image-20230721103510572.png)

分类示例：

![image-20230721103937203](E:\machine learning\img\image-20230721103937203.png)
...
![image-20230721104950717](E:\machine learning\img\image-20230721104950717.png)

3. 正则化（Regularization）（一种更为温和的方式去减少某些特征的影响，而不用将其彻底消除这么严厉）

![image-20230721105539023](E:\machine learning\img\image-20230721105539023.png)
...
![image-20230721165327681](E:\machine learning\img\image-20230721165327681.png)

lambda：正则化系数（参数）

当lambda过小：可能导致over fitting。当lambda过大：可能会导致under fit。

![image-20230721165739652](E:\machine learning\img\image-20230721165739652.png)

###### 用于线性回归的正则方法

梯度下降：

![image-20230721170612321](E:\machine learning\img\image-20230721170612321.png)

将偏导带回wj和b中，得到表达式:

![image-20230721170718684](E:\machine learning\img\image-20230721170718684.png)

表达式背后的意义：正则化在每次迭代所做的事情是将w乘以一个略小于1的数，这样做会稍微缩小wj的值

![image-20230721171403044](E:\machine learning\img\image-20230721171403044.png)
$$
...
![image-20230721172228711](E:\machine learning\img\image-20230721172228711.png)

梯度下降：

![image-20230721172423020](E:\machine learning\img\image-20230721172423020.png)
...
![image-20230723100905567](E:\machine learning\img\image-20230723100905567.png)

多个隐藏层示例：

![image-20230723100943503](E:\machine learning\img\image-20230723100943503.png)
...
![image-20230723100620387](E:\machine learning\img\image-20230723100620387.png)

将layer2（输出层）进行放大观察其内部细节：

![image-20230723101433540](E:\machine learning\img\image-20230723101433540.png)

公式：![image-20230723103823351](E:\machine learning\img\image-20230723103823351.png)其中l代表第layer l层，j代表第l层的第j个neuron，g代表激活函数，请注意公式中哪些是向量，哪些是标量，不要弄混淆了。





![image-20230723103802767](E:\machine learning\img\image-20230723103802767.png)

#### 前向传播

![image-20230723105210037](E:\machine learning\img\image-20230723105210037.png)
...
![image-20230723170606785](E:\machine learning\img\image-20230723170606785.png)

![image-20230723171139361](E:\machine learning\img\image-20230723171139361.png)
...
![image-20230723172635585](E:\machine learning\img\image-20230723172635585.png)

#### 构建一个神经网络

前面所学的构建神经网络模型：

![image-20230724101014219](E:\machine learning\img\image-20230724101014219.png)
...
![image-20230724102044383](E:\machine learning\img\image-20230724102044383.png)

代码底层所做的事情：（为每个神经元硬编码，较为不方便）

![image-20230724103155779](E:\machine learning\img\image-20230724103155779.png)
...
1. 定义dense函数，将前一层的激活以及给定层的神经元参数w和b作为输入。函数的作用是从上一层输入一个激活值，然后输出当前层的激活值。
   ...
   ![image-20230724112216452](E:\machine learning\img\image-20230724112216452.png)
...
![image-20230724105729681](E:\machine learning\img\image-20230724105729681.png)

#### 神经网络为什么如此高效

原因：矢量化

![image-20230724165500919](E:\machine learning\img\image-20230724165500919.png)
...
![image-20230725172738615](E:\machine learning\img\image-20230725172738615.png)

1. model = Se....

![image-20230725173000001](E:\machine learning\img\image-20230725173000001.png)

2.告诉TensorFlow loss function also define cost function

![image-20230725173652146](E:\machine learning\img\image-20230725173652146.png)

3.model.fit()

![image-20230725174132912](E:\machine learning\img\image-20230725174132912.png)

#### 激活函数

linear activation function（此时相当于没有激活函数 g(z) = z） 、sigmoid function和ReLU function

![image-20230725175215035](E:\machine learning\img\image-20230725175215035.png)
...
![image-20230725215624902](E:\machine learning\img\image-20230725215624902.png)

![image-20230725215459898](E:\machine learning\img\image-20230725215459898.png)

#### Softmax

Softmax回归算法是逻辑回归的推广

![image-20230726102235114](E:\machine learning\img\image-20230726102235114.png)

Softmax回归算法的损失函数：----> 成本函数是损失函数的总和/m，在TensorFlow中成本函数被叫做SparseCategoricalCrossentropy

![image-20230726102805487](E:\machine learning\img\image-20230726102805487.png)

#### 神经网络中的Softmax输出

注意：a1是z1、z2...z10的函数，这是softmax与其他激活函数的不同，其他激活函数只是z的函数。

![image-20230726103816907](E:\machine learning\img\image-20230726103816907.png)

在TensorFlow中的代码实现：（不推荐版）

![image-20230726104449631](E:\machine learning\img\image-20230726104449631.png)
...
在二元分类中![image-20230726105759196](E:\machine learning\img\image-20230726105759196.png)由于a是个浮点数，此时在计算成本函数的时候，传统的方法是不显示的带入a的值进入成本函数之中，此时相当于引例1中的后者例子，而改进的损失函数就是将a的值显示的带入到损失函数之中（此时相当于引例1中的前者)，这样有利于防止精度损失。![image-20230726110054706](E:\machine learning\img\image-20230726110054706.png)代码实现如下：

![image-20230726110117980](E:\machine learning\img\image-20230726110117980.png)
...
![image-20230726111006324](E:\machine learning\img\image-20230726111006324.png)

此时神经网络最后一层不再输出a1，a2...a10,（即为预测概率）而是输出z1，z2...z10的中间结果，因此在最后预测的时候还要进行再操作---> f_x = tf.nn.softmax(logits)

![image-20230726112022448](E:\machine learning\img\image-20230726112022448.png)

二元逻辑回归也是：在预测的时候必须更改代码来获取输出值，并将其映射通过逻辑函数来实际得到概率

![image-20230726112609476](E:\machine learning\img\image-20230726112609476.png)
...
![image-20230726164546859](E:\machine learning\img\image-20230726164546859.png)

在TensorFlow中adam算法的实现：

![image-20230726165002804](E:\machine learning\img\image-20230726165002804.png)
...
![image-20230726165944418](E:\machine learning\img\image-20230726165944418.png)

卷积神经网络的具体例子：

![image-20230726170610032](E:\machine learning\img\image-20230726170610032.png)



#### 计算图

![image-20230727103223395](E:\machine learning\img\image-20230727103223395.png)
...
![image-20230731163724937](E:\machine learning\img\image-20230731163724937.png)

##### 逻辑回归：

![image-20230731164257469](E:\machine learning\img\image-20230731164257469.png)
...
![image-20230731165335329](E:\machine learning\img\image-20230731165335329.png)
...
![image-20230731172453631](E:\machine learning\img\image-20230731172453631.png)

修改划分后的Jtrain、Jtest和Jcv：

![image-20230731172634981](E:\machine learning\img\image-20230731172634981.png)



交叉训练集用于模型选择，选择出Jcv最小的一个模型：

![image-20230731175335272](E:\machine learning\img\image-20230731175335272.png)

![image-20230731175500061](E:\machine learning\img\image-20230731175500061.png)



##### bias（偏差） and variance（方差）进行诊断

![image-20230805164759574](E:\machine learning\img\image-20230805164759574.png)
...
![image-20230805165938226](E:\machine learning\img\image-20230805165938226.png)

##### 正则化（lambda）对bias和variance的影响

![image-20230805171108071](E:\machine learning\img\image-20230805171108071.png)

选择lambda的方法（和之前选择degree的程度类似）--->总结使用众多Jcv当中的最小值去选择degree（D）和lambda

当D和lambda的选择不恰当时，都会出现high bias或者high variance

![image-20230805171447329](E:\machine learning\img\image-20230805171447329.png)

![image-20230805172009359](E:\machine learning\img\image-20230805172009359.png)
...
![image-20230805173358682](E:\machine learning\img\image-20230805173358682.png)

选取基准线的方法：

![image-20230805173541124](E:\machine learning\img\image-20230805173541124.png)

eg：查看baseline和training error的误差是否会很大判断是否有high bias 查看training error和 cv error的差别看是否有high variance

![image-20230805173931231](E:\machine learning\img\image-20230805173931231.png)
...
![image-20230805214314868](E:\machine learning\img\image-20230805214314868.png)

high bias的学习曲线（under fitting）--->模型选的过于简单，导致无论增加多少新数据都不会降低错误率

![image-20230805215505918](E:\machine learning\img\image-20230805215505918.png)

high variance的学习曲线（over fitting）

模型的错误率可以随着训练集数量的增多而逐渐趋于baseline

![image-20230805220149415](E:\machine learning\img\image-20230805220149415.png)
...
![image-20230806155509907](E:\machine learning\img\image-20230806155509907.png)

当神经网络中的层和每一层当中的unit增加时是否会出现high variance问题？---> 不会（只要你的正则化参数选择的合适），但可能会减慢你拟合的速度

![image-20230806160003159](E:\machine learning\img\image-20230806160003159.png)

TensorFlow中神经网络中正则化的方法：

![image-20230806160503658](E:\machine learning\img\image-20230806160503658.png)

#### 机器学习的迭代过程

![image-20230806161132328](E:\machine learning\img\image-20230806161132328.png)
...
![image-20230806164448465](E:\machine learning\img\image-20230806164448465.png)
...
![image-20230806170832026](E:\machine learning\img\image-20230806170832026.png)

4. 数据合成--->eg:使用电脑技术合成一些不同样式的字母进行训练

在图像数据中进行平移、旋转、缩放、翻转等变换，或者在文本数据中进行同义词替换、词序交换等操作。此外，还可以利用生成对抗网络（GANs）等生成模型来合成逼真的新数据样本。

![image-20230806171224349](E:\machine learning\img\image-20230806171224349.png)

#### 迁移学习

![image-20230806215223600](E:\machine learning\img\image-20230806215223600.png)
...
![image-20230806220302833](E:\machine learning\img\image-20230806220302833.png)
...
![image-20230807102215592](E:\machine learning\img\image-20230807102215592.png)

在步骤4部署中可能要考虑的问题：

![image-20230807103359382](E:\machine learning\img\image-20230807103359382.png)
...
![image-20230807164232212](E:\machine learning\img\image-20230807164232212.png)
...
![image-20230807170350454](E:\machine learning\img\image-20230807170350454.png)

在多组学习算法当中如何根据precision和recall选择哪一组？

使用F1 score的方式（调和平均数，更强调教小值的平均值）

![image-20230807171151453](E:\machine learning\img\image-20230807171151453.png)

### 3.2 decision trees

eg：

![image-20230808212312113](E:\machine learning\img\image-20230808212312113.png)
...
![image-20230808214200933](E:\machine learning\img\image-20230808214200933.png)



![image-20230808215302938](E:\machine learning\img\image-20230808215302938.png)
...
![image-20230809095956207](E:\machine learning\img\image-20230809095956207.png)
...
![image-20230809101704256](E:\machine learning\img\image-20230809101704256.png)
...
![image-20230809102313882](E:\machine learning\img\image-20230809102313882.png)

#### 对前面所学的整合

![image-20230809102841582](E:\machine learning\img\image-20230809102841582.png)
...
![image-20230809104813305](E:\machine learning\img\image-20230809104813305.png)

#### 如何对连续的取值特征进行构建决策树

方法：考虑要拆分的不同值，计算信息增益取信息增益值最大（熵变化最大的），此时选择对应的值进行拆分即可

![image-20230809155914249](E:\machine learning\img\image-20230809155914249.png)

![image-20230809160133431](E:\machine learning\img\image-20230809160133431.png)
...
![image-20230809160918479](E:\machine learning\img\image-20230809160918479.png)

回归模型的决策树如何进行特征分割？

在决策树当中，选择的是使用熵进行特征分割，而在回归模型的决策树当中则是尝试减少每个数据子集Y的权重方差。

![image-20230809161837145](E:\machine learning\img\image-20230809161837145.png)
...
![image-20230809162414563](E:\machine learning\img\image-20230809162414563.png)

构建出多颗决策树，然后对预测样本分别进行决策，预测结果多的为最终结果

![image-20230809162722475](E:\machine learning\img\image-20230809162722475.png)

#### 如何通过替换采样技术构建多颗决策树

在训练集（10个）里面连续抽10次，注意每次抽的时候都要将样本放回，这样相当于构建了一个新的训练集，但数据还是原来的。

![image-20230809163448339](E:\machine learning\img\image-20230809163448339.png)

#### 随机森林

在进行了替换采样技术生成了多个训练集后，可能会导致生成的多颗决策树长得一样，这样算法的健壮性就不好，因此引出了随机森林：

![image-20230809164840973](E:\machine learning\img\image-20230809164840973.png)

决策森林：在对每一个节点进行特征分割时，不再是对所有的（n个特征）进行选择信息增益最大的，而是随机从k个（k一般=根号n）中进行选择信息增益最大的。

![image-20230809165038130](E:\machine learning\img\image-20230809165038130.png)
...
![image-20230809221334231](E:\machine learning\img\image-20230809221334231.png)

XGboost优势：

![image-20230809221721981](E:\machine learning\img\image-20230809221721981.png)
...
![image-20230809220954287](E:\machine learning\img\image-20230809220954287.png)

#### 什么时候使用决策树/神经网络

![image-20230809222825763](E:\machine learning\img\image-20230809222825763.png)
...
![image-20230811165940946](E:\machine learning\img\image-20230811165940946.png)

![image-20230811173348203](E:\machine learning\img\image-20230811173348203.png)
...
![image-20230811175854948](E:\machine learning\img\image-20230811175854948.png)
...
![image-20230811180612898](E:\machine learning\img\image-20230811180612898.png)



如何解决？--->使用多个随机初始化K

![image-20230811181022115](E:\machine learning\img\image-20230811181022115.png)
...
![image-20230813215848597](E:\machine learning\img\image-20230813215848597.png)

异常检测的应用：

![image-20230813220522731](E:\machine learning\img\image-20230813220522731.png)

#### 高斯分布（正态分布）

![image-20230813221111323](E:\machine learning\img\image-20230813221111323.png)

![image-20230813221339718](E:\machine learning\img\image-20230813221339718.png)
...
![image-20230813221838768](E:\machine learning\img\image-20230813221838768.png)

##### 具有多维特征的密度估计

![image-20230815170501530](E:\machine learning\img\image-20230815170501530.png)

步骤：

![image-20230815171303697](E:\machine learning\img\image-20230815171303697.png)

eg：

![image-20230815171633214](E:\machine learning\img\image-20230815171633214.png)
...
![image-20230815185513438](E:\machine learning\img\image-20230815185513438.png)

eg：

![image-20230815190527567](E:\machine learning\img\image-20230815190527567.png)
...
![image-20230815192909499](E:\machine learning\img\image-20230815192909499.png)

![image-20230815193231344](E:\machine learning\img\image-20230815193231344.png)
...
![image-20230816162318735](E:\machine learning\img\image-20230816162318735.png)

尝试寻找一些新的特征以便让在原来的特征里是异常的被误分为正常的训练样本可以在新的特征样本中得到解决

![image-20230816164150648](E:\machine learning\img\image-20230816164150648.png)

![image-20230816164652391](E:\machine learning\img\image-20230816164652391.png)
...
![image-20230820175657528](E:\machine learning\img\image-20230820175657528.png)

引例：查看用户未评价的电影，并尝试预测用户将会如何评价电影（这样就可以向用户推荐他们更有可能评价为五星的电影）

![image-20230819204501310](E:\machine learning\img\image-20230819204501310.png)

为每一部电影引入两个新特征（浪漫片or动作片），下面使用线性回归模型为用户暂时未评分的电影预测评分。

![image-20230819205818590](E:\machine learning\img\image-20230819205818590.png)

定义成本函数：（与线性回归模型的成本函数类似）

![image-20230819210726474](E:\machine learning\img\image-20230819210726474.png)

由于mj只是一个常数，因此直接将mj消除后求成本函数的最小值所得到的w与b是一样的。

![image-20230819211207288](E:\machine learning\img\image-20230819211207288.png)

假如电影没有额外的特征（爱情片or动作片）如何修改算法？

从数据中学习或得出这些特征，假设已经知道了w和b参数的值，这样就可以通过多个用户协同过滤的方式学习到特征的值

![image-20230819212449625](E:\machine learning\img\image-20230819212449625.png)

计算特征的成本函数：注意正则化项与前面的不同之处

![image-20230819213228865](E:\machine learning\img\image-20230819213228865.png)

### 协同过滤算法

使用协同过滤算法是对上面的两个成本函数的总结，在第一个成本函数之中我们已知了特征值而不知道参数w和b，因此我们使用![image-20230819214445614](E:\machine learning\img\image-20230819214445614.png)来选择w和b的值，在第二个成本函数中我们已知了参数w和b的值而不知道特征x（i)，因此我们使用![image-20230819214554528](E:\machine learning\img\image-20230819214554528.png)
...
![image-20230819214313198](E:\machine learning\img\image-20230819214313198.png)
...
![image-20230819215554550](E:\machine learning\img\image-20230819215554550.png)

### 二进制标签

此时只关心用户是否喜欢这个电影（预测是否会点赞/收藏）

![image-20230819220221375](E:\machine learning\img\image-20230819220221375.png)

二进制标签应用举例：

![image-20230819220630144](E:\machine learning\img\image-20230819220630144.png)

算法实现：（与线性回归模型到逻辑回归模型类似）

![image-20230819220838328](E:\machine learning\img\image-20230819220838328.png)

二元制标签成本函数：

![image-20230819221628014](E:\machine learning\img\image-20230819221628014.png)
...
![image-20230820163501985](E:\machine learning\img\image-20230820163501985.png)
...
![image-20230820165640612](E:\machine learning\img\image-20230820165640612.png)

### TensorFlow的auto diff

在TensorFlow中可以给出成本函数的计算公式后，根据一定的语法自动去运行梯度下降，避免手动的去计算导数（偏导数），示例如下

![image-20230820170721827](E:\machine learning\img\image-20230820170721827.png)

### 协同过滤算法在TensorFlow中的实现

![image-20230820171510748](E:\machine learning\img\image-20230820171510748.png)

### 寻找相关特征（寻找类似的电影、书籍）

​		如何实现寻找类似的电影、书籍，此时只需要计算另一些电影、书籍与当前的特征之间的距离，选择距离最小的就是类似的。

![image-20230820173345287](E:\machine learning\img\image-20230820173345287.png)
...
![image-20230820173910030](E:\machine learning\img\image-20230820173910030.png)
...
![image-20230822094419610](E:\machine learning\img\image-20230822094419610.png)

#### 基于内容过滤算法的实现步骤：

1. 构建user feature和movie feature，两个向量的大小可以不一样

![image-20230822095607517](E:\machine learning\img\image-20230822095607517.png)
...
![image-20230822100837402](E:\machine learning\img\image-20230822100837402.png)

3. 计算v_u和v_m（使用神经网络模型）

![image-20230822101847931](E:\machine learning\img\image-20230822101847931.png)

4. 成本函数

![image-20230822102433989](E:\machine learning\img\image-20230822102433989.png)

基于内容的过滤算法如何找类似item？

和协同过滤算法寻找相关书籍（电影类似）只要计算v_m(k)和v_m(i)之间的距离，选择距离最小的几个即可。

![image-20230822102819189](E:\machine learning\img\image-20230822102819189.png)

TensorFlow中的基于内容过滤算法实现：

![image-20230822165334128](E:\machine learning\img\image-20230822165334128.png)
...
![image-20230822103814911](E:\machine learning\img\image-20230822103814911.png)

2. ranking

![image-20230822104056005](E:\machine learning\img\image-20230822104056005.png)
...
![image-20230822105619586](E:\machine learning\img\image-20230822105619586.png)
...
![image-20230822205115113](E:\machine learning\img\image-20230822205115113.png)

PCA技术将50多个特征压缩到2个

![image-20230822205513530](E:\machine learning\img\image-20230822205513530.png)
...
![image-20230822211446386](E:\machine learning\img\image-20230822211446386.png)

PCA不是linear regression，首先PCA是无监督学习的一种，线性回归模型是对y进行预测，而PCA是将多个特征进行压缩，在压缩的过程之中尽可能的保持方差

![image-20230822212211217](E:\machine learning\img\image-20230822212211217.png)

#### PCA的重建

给定压缩后的距离可以近似的得到压缩前的数据位置，这个过程叫做PCA的重建，具体步骤如下，其中[0.71,0.71]是z方向上的单位向量，3.55是压缩后数据在z轴上的距离。

![image-20230822212816308](E:\machine learning\img\image-20230822212816308.png)

#### PCA的代码实现

![image-20230822213531818](E:\machine learning\img\image-20230822213531818.png)

![image-20230822214023426](E:\machine learning\img\image-20230822214023426.png)



![image-20230822214300468](E:\machine learning\img\image-20230822214300468.png)
...
![image-20230826171055102](E:\machine learning\img\image-20230826171055102.png)

### 强化学习的回报

折扣因子：走n步折扣因子^n

![image-20230826171755946](E:\machine learning\img\image-20230826171755946.png)

eg:

![image-20230826172410502](E:\machine learning\img\image-20230826172410502.png)

### 强化学习算法如何选择动作

如何选择动作--->提出一个称为策略π的函数，告诉你在每个状态下采取什么样的行动以最大化回报。

![image-20230826173056622](E:\machine learning\img\image-20230826173056622.png)

![image-20230826172915973](E:\machine learning\img\image-20230826172915973.png)

![image-20230827101054562](E:\machine learning\img\image-20230827101054562.png)

马尔科夫决策过程：未来仅取决于当前状态，而不取决于在达到当前状态之前可能会发生的任何事情（未来仅取决于你现在的位置，而不取决于你是如何到达的）

![image-20230827101513172](E:\machine learning\img\image-20230827101513172.png)
...
![image-20230827102534420](E:\machine learning\img\image-20230827102534420.png)

![image-20230827103612530](E:\machine learning\img\image-20230827103612530.png)
...
![image-20230827105559297](E:\machine learning\img\image-20230827105559297.png)

eg:

![image-20230827110017104](E:\machine learning\img\image-20230827110017104.png)



**在强化学习中获得的回报有两部分：一部分是立即获得的奖励，另一部分是gamma从下一个状态获得的回报**

![image-20230827110704211](E:\machine learning\img\image-20230827110704211.png)
...
![image-20230827165050701](E:\machine learning\img\image-20230827165050701.png)



#### 贝尔曼方程

![image-20230827165241318](E:\machine learning\img\image-20230827165241318.png)
...
![image-20230828214514898](E:\machine learning\img\image-20230828214514898.png)



算法实现

![image-20230828111425608](E:\machine learning\img\image-20230828111425608.png)
...
![image-20230828214926815](E:\machine learning\img\image-20230828214926815.png)

##### epsilon-贪婪策略

在算法还在运行的时候，此时还不知道在状态s下的哪个action可以最大化Q（s，a）此时就可以采取epsilon-贪婪策略进行选取（大部分时间选取最大化的Q（s，a）少部分时间随机选取）spsilon的值可以随着训练时间的增加逐渐减小

![image-20230828220147864](E:\machine learning\img\image-20230828220147864.png)
...
![image-20230829095856338](E:\machine learning\img\image-20230829095856338.png)

![image-20230829100032461](E:\machine learning\img\image-20230829100032461.png)

mini-batch成本函数可能会出现一些偏差，但总体还是趋向于最小值：

![image-20230829100239787](E:\machine learning\img\image-20230829100239787.png)

###### 小批量在强化学习中的使用

![image-20230829100549882](E:\machine learning\img\image-20230829100549882.png)

##### soft update（op）

所谓soft update即为在强化学习中使用mini-batch后如果直接将Q = Qnew可能会因为一些不是很好的小组导致Qnew不如原来的Q，这样就可以采用soft update来对Q进行更新

![image-20230829102817602](E:\machine learning\img\image-20230829102817602.png)

![image-20230829104546864](E:\machine learning\img\image-20230829104546864.png)
